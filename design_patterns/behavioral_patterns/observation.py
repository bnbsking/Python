"""
multiple instance follow 1 changeable instance
e.g.
    subscriber implements update
    Youtuber implements
        Add_subscriber
        Remove_subscriber
...
class Subject(ABC):  # abstract YTR
    """
...
class ConcreteSubject(Subject):  # YTR
    """
